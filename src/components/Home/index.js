            ...
            <Header/>
                <div className="banner-container">
                  <div className="banner-details">  
                    <div>
                        <h1 className="banner-heading">Bootcamp Submissions</h1>
                        <p className="banner-para">Fd camp provides online web bootcamp submission used to collect data and review applications <br/> from aspiring front-end developers. It typically includes fields for title, description, name, links,<br/> and other infos of the application process for bootcamp programs. 
                        </p>
