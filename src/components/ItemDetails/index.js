...
export default function ItemDetails(props){ 
    ...
    const onClickStar=()=>{
        setActive(!active);
        console.log(active)
        if(!active && dataList[0].favoriteType==="NO"){
            ...
            submissionData.map(eachItem=>{
                if(eachItem.id===id){
                    return eachItem.favoriteType="NO"
                }
                return eachItem
            })
        }
    ...
    return (
        ...
        <div className="details-banner-container">
                  ...
                  {close => (
                    ...
                    <div className="bottom-details">
                        <div className="star">
                            <button className="star-btn" onClick={onClickStar}> <AiFillStar  size={18} style={{color:dataList[0].favoriteType==="YES"?"yellow":"#ffffff",marginTop:"3px"}}/></button>
                        </div>
        ...
        <div className="details-description-conatiner">
            ...
            <div className="other-details">
                <p className="desc-name">Bootcamp</p>
